...
namespace Projeto02.Contexto
{
    public class Context : DbContext
    {
        ...
        {
            //modelBuilder.Entity<Software>().Property("Nome").IsRequired();
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder options)
        {
            ...
            {
                options.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Projeto02;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
    }
}